...
class OTPSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        user = list(NewUserRegistration.objects.filter(email=email))
        if user != []:
...
class NewUserSerializer(serializers.ModelSerializer):
    ...
    def create(self, data):
        userOTP = OTP.objects.get(email=data["email"])
        user = NewUserRegistration.objects.create(
            name=data["name"],
...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        try:
            NewUserRegistration.objects.get(email=data["email"])
        except:
...
class ResetPasswordViewOTPSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        try:
            NewUserRegistration.objects.get(email=email)
        except:
